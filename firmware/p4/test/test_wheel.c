...
int main(void) {
    ...
    wheel_params_t a = { .diameter_mm = 65, .ppr = 11, .gear_x100 = 900, .quad = 4 };
    assert(feq(wheel_cpr(&a), 396.0f));
    // generic high gearing: 11 PPR · 1:21 · ×4 → 924
    wheel_params_t b = { .diameter_mm = 65, .ppr = 11, .gear_x100 = 2100, .quad = 4 };
    assert(feq(wheel_cpr(&b), 924.0f));
