...
| The adapter updates itself over the air | Works, and it was the oldest item on this list. Both boards flashed by cable at `v1.0+747`, release `v1.0+749` published, no cable touched since — and both now run `v1.0+749`. The only route between the two is the app | 2026-09-01 |
