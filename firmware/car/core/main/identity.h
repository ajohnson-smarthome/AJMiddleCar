...
// SSID is necessary but not sufficient: point the dongle at the wrong network and the pult
// finds a car exactly where it expects one. CAR_DEVICE_ID is what lets it refuse.
