...
ENDPOINTS = {'root': '/', 'status': '/status', 'config': '/config', 'calibration': '/calibration', 'spin': '/calibration/spin', 'ota': '/ota'}
...
STATUS_GROUPS = ['device', 'link', 'motors', 'radio', 'storage', 'system']
...
RT = {'port': 4210, 'max_datagram': 320, 'max_command': 96, 'command_hz': 10, 'telemetry_hz': 5, 'watchdog_ms': 300, 'session_idle_ms': 10000, 'keys': {'proto': 'proto', 'type': 'type', 'session': 'session', 'seq': 'seq', 'throttle': 'throttle', 'turn': 'turn'}, 'types': {'hello': 'hello', 'hello_ack': 'hello_ack', 'drive': 'drive', 'bye': 'bye', 'telemetry': 'telemetry'}, 'doc': 'Every datagram carries proto and type. session is the session id: producers send 8 hex characters; acceptors take 1-15 alphanumerics. drive and bye carry seq; hello does not.'}
TELEMETRY_GROUPS = ['link', 'motors', 'system']
