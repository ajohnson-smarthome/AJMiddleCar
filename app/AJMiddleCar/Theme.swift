...
enum Theme {
    static let dark = Palette(
        ...
        accent:    Color(red: 0.290, green: 0.612, blue: 0.949),
        idleWheel: Color(red: 0.227, green: 0.294, blue: 0.373),
    ...
    static let light = Palette(
        ...
        accent:    Color(red: 0.082, green: 0.361, blue: 0.639),
        idleWheel: Color(red: 0.812, green: 0.855, blue: 0.906),
